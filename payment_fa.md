...
* [لیست درگاه ها(اختیاری)](#دریافت-لیست-درگاه-ها)
...
## لیست درگاه ها(اختیاری)
برای دریافت لیست درگاه های فعال پذیرنده
### endpoint
...
- `gateway_slug`: اسلاگ درگاه که پیش فرض زرین پلاس میباشد
