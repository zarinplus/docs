...
* [پرداخت](#پرداخت)
	* [لیست درگاه ها](#دریافت-لیست-درگاه-ها)*جدید
	* [ایجاد درخواست پرداخت](#ایجاد-درخواست-پرداخت)*بهبود
	* [لغو تراکنش](#لغو-تراکنش)
	* [تأیید تراکنش](#تأیید-تراکنش)
	* [بازگشت تراکنش](#بازگشت-تراکنش)
    * [بازگشت قسمتی از تراکنش](#بازگشت-قسمتی-از-تراکنش)
...
- `gateway_slug`: یکی از اسلاگ های سرویس قبل را باید در این پارامتر قرار دهید
